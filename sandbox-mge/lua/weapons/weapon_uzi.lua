...
game.AddAmmoType({name = "uzibullets"})
if CLIENT then
	language.Add("uzibullets_ammo", "Bullets")
end

SWEP.PrintName = "Uzi"
SWEP.Instructions = [[
<color=green>[PRIMARY FIRE]</color> Fire shitloads of bullets.]]
